...
export class BornCategoryComponent {
  ...
  deleteBornCategoryByid(bornCategoryId: any) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        //save File
        this.bornCategoryService
          .deletebornCategoryByIdService(bornCategoryId)
          .subscribe({
            next: (res: any) => {
              this.toast.success({
                detail: 'Success',
  ...
  getBornCategoryById(bornCategoryid: any) {
    ...
    bornCategoryid;
    this.bornCategoryService
      .getBornCategoryByIdService(bornCategoryid)
      .subscribe({
        next: (res: any) => {
  ...
  bornMappedSampleFies(
    enterAnimationDuration: string,
    exitAnimationDuration: string,
    bornCategoryId: any
  ): void {
    const dialogRef = this.bornMappedSampleFiesDialog.open(
